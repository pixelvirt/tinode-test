...
class MessagesView extends React.Component {
    constructor(props) {
        ...
        this.handleAttachImageOrVideo =
            this.handleAttachImageOrVideo.bind(this);
    ...
    componentSetup(prevProps, prevState) {
        ...
        if (this.state.topic != prevState.topic) {
            if (
                prevState.topic &&
                !Tinode.isNewGroupTopicName(prevState.topic)
            ) {
            ...
            if (!uploader) {
                this.props.onError(
                    this.props.intl.formatMessage(
                        messages.cannot_initiate_upload
                    )
                );
                return;
            }
            ...
            if (this.state.imagePreview) {
                ...
                topic.messages((msg, prev, next, i) => {
                    ...
                    if (msg.hi) {
                        // Deleted message.
                        messageNodes.push(
                            <MetaMessage deleted={true} key={msg.seq} />
                        );
                    } else {
                    ...
                    <>
                        ...
                        !this.state.unconfirmed ? (
                            <div id="peer-messaging-disabled-note">
                                <i className="material-icons secondary">
                                    block
                                </i>{" "}
                                <FormattedMessage
                        ...
                        {this.state.unconfirmed ? (
                            ...
                            <SendMessage
                                ...
                                disabled={
                                    !this.state.isWriter || this.state.deleted
                                }
                                reply={this.state.reply}
